        ...
        <div 
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 py-8 text-brand-green">
            <div className="overflow-hidden max-h-fit">
              <img className="w-full rounded-lg h-64 object-cover" src="https://www.labrujula24.com/wp-content/webp-express/webp-images/uploads/2021/11/sierra.jpg.webp" alt="Actividad 1" />
              <div className="p-6">
            ...
            <div className="overflow-hidden max-h-fit">
              <img className="w-full rounded-lg h-64 object-cover" src="https://fotos.perfil.com/2022/11/07/club-hotel-de-villa-ventana-20221107-1449645.jpg" alt="Actividad 2" />
              <div className="p-6">
