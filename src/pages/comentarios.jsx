        ...
        <section className="px-4 py-10 mb-10">
          <div className="max-w-6xl mx-auto">
            ...
            <p className="text-black font-medium text-xl mb-8 pr-8">
              Nuestros huéspedes son nuestra prioridad, ofrecemos una
              experiencia acogedora, cálida y auténtica para cada uno de
              nuestros visitantes. Queremos que te sientas como en casa!
            </p>
            <Slider {...settings}>
              {comments.map((comment, i) => (
                <div
                  key={i}
                  className="w-96 p-6 h-80 cursor-grab active:cursor-grabbing shrink-0"
                >
