			...
			<div className="flex flex-grow items-center justify-between py-4 px-4 shadow-2 md:px-6 2xl:px-11">
					...
					<button
						...
						<span className="relative block h-5.5 w-5.5 cursor-pointer">
							...
							{/* <span className="du-block absolute right-0 h-full w-full rotate-45">
								...
								<span
									className={`delay-400 absolute left-0 top-2.5 block h-0.5 
															w-full rounded-sm bg-black duration-200 
															ease-in-out 
				...
				<div className="flex items-center gap-3 2xsm:gap-7">
					...
					************************
						...
						<li className="relative" x-data="{ dropdownOpen: false, notifying: true }" @click.outside="dropdownOpen = false">
							<a className="relative flex h-8.5 w-8.5 items-center justify-center rounded-full border-[0.5px] border-stroke bg-gray hover:text-primary"
								...
								<span :className="!notifying && 'hidden'" className="absolute -top-0.5 right-0 z-1 h-2 w-2 rounded-full bg-meta-1">
									<span
