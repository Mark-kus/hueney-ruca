							...
							<div id="FileUpload"
								...
								<div className="flex flex-col items-center justify-center space-y-3">
									...
									<p className="font-medium text-sm">
										<span className="text-primary">Haz click aquí</span>
										o arrástra una foto aquí
									</p>
									<p className="mt-1.5 font-medium text-sm">JPG, PNG o WEBP</p>
									<p className="font-medium text-sm opacity-60">- medidas máximas: 800 x 800px -</p>
								</div>
							</div>
